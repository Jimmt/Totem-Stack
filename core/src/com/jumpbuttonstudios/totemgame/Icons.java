...
public class Icons {
	...
	public static String[] paths = { "bg/bigrock.png", "bg/Clouds00.png", "bg/Clouds01.png",
	...
	public static Image returnImage(String path) {
		...
		if (!assetManager.containsAsset(path)) {
			i = new Image(new Texture(Gdx.files.internal(path)));
		} else {
			i = new Image(assetManager.get(path, Texture.class));
		}
